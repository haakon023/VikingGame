...
public class LeaderboardState implements Screen {
    ...
    */
    public LeaderboardState(final VikingGame vikingGame) {
    ...
    public void render(float delta) {
        ...
        vikingGame.font48.draw(vikingGame.batch, "Leaderboard State", 20,80);
